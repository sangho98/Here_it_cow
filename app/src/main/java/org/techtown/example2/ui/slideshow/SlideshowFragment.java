package org.techtown.example2.ui.slideshow;
...
public class SlideshowFragment extends Fragment implements OnMapReadyCallback {
    ...
    private android.location.Location mCurrentLocatiion;
    ...
    private static final int FASTEST_UPDATE_INTERVAL_MS = 1000 * 2; // 2초 단위로 화면 갱신
